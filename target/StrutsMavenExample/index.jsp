...
<div class="row7">
	...
	<s:label>_____________________________________________________</s:label>



	<h4>Basic helloWorld with URLm Href and property Tags combined with class.</h4>
	<!--  note in this example userName is never used in any action class -->
	<p>
	...
	<p><s:label> OR call action to display register.jsp</s:label></P>
	...
	<h4>Exception handling, This demonstrates how exception actions can be used if exceptions are not handled</h4>
	...
	<h3>Debugging - This is nice, check it out!!!</h3>

    <!--  im guessing that the namespace config-browser is set up in the actual pluggin  -->
...
>>>>>>> a3f1fb02892a052769d4578008d88108ec749b67
